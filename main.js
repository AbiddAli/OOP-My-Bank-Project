...
// CREATE CUSTOMERS
const customers = [
    new Customer("Abid", "Ali", "Male", 35, 3102256786, accounts[0]),
    new Customer("Muhammad", "Umar", "Male", 32, 3334567234, accounts[1]),
    new Customer("Usman", "Khan", "Male", 30, 3101122456, accounts[2])
];
